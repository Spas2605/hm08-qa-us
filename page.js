module.exports = {
    ...
    linkCardButton: '//button[starts-with(text(), "Link")]',
    supportiveClass: '//div[starts-with(text(), "Supportive")]',
    supportiveMode: 'div=Supportive',
    orderRequirmentsButton: '.reqs-header',
    blanketLink: '.r-type-link',
    blanketAndHandkerchiefsButton: '.switch',
    iceCreamValueButton:'.counter .counter-value',
    iceCreamPlusButton: '.counter-plus',
    orderButton: '.smart-button',
    // Modals
    phoneNumberModal: '.modal',
    cardNumberModal: '.modal',
    closePaymentMethodModal: '.payment-picker .section.active .close-button',
    ...
    addPaymentMethodCard: async function () {
        ...
        const closePaymentMethodModal = await $(this.closePaymentMethodModal);
        await closePaymentMethodModal.waitForDisplayed();
        await closePaymentMethodModal.click();
    }
};